...
尽管 Groovy 是一种动态语言，但它可以在编译时与<<static-type-checking,静态类型检查器>>一起使用，并使用 @TypeChecked 注释启用。在这种模式下，编译器会变得更加冗长，并会抛出错误，例如拼写错误、不存在的方法等。不过，这也有一些限制，其中大部分来自 Groovy 本质上仍然是一种动态语言。例如，您将无法对使用标记生成器的代码进行类型检查：

[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=intro_stc_extensions,indent=0]
----
...
[source,groovy]
--------------
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_script,indent=0]
--------------
...
[source,groovy]
----------------------------
include::../../test/typing/Robot.groovy[tags=example_robot_classdef,indent=0]
----------------------------
...
[source,groovy]
------------------------------------------------------------------------------
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_setup,indent=0]
------------------------------------------------------------------------------
...
------------------------------------------------------------
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_expected_err,indent=0]
------------------------------------------------------------
...
[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_fixed_conf,indent=0]
----
...
-------------------------------------
include::../../test-resources/robotextension.groovy[tags=example_robot_extension,indent=0]
-------------------------------------
...
[source,groovy]
----
include::../../test-resources/setup.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/finish.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/unresolvedvariable.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/unresolvedproperty.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/unresolvedattribute.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/beforemethodcall.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/aftermethodcall.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/onmethodselection.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/methodnotfound.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/beforevisitmethod.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/aftervisitmethod.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/beforevisitclass.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/aftervisitclass.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/incompatibleassignment.groovy[tags=event,indent=0]
----
...
[source,groovy]
----
include::../../test-resources/ambiguousmethods.groovy[tags=event,indent=0]
----
...
[source,groovy]
--------------------
include::../../test-resources/selfcheck.groovy[tags=classnodefor,indent=0]
--------------------
...
[source,groovy]
----
include::../../test-resources/selfcheck.groovy[tags=lookupclassnodefor,indent=0]
----
...
[source,groovy]
----------------------------------------------------------------------------------------------
include::../../test-resources/newmethod.groovy[tags=newmethod,indent=0]
----------------------------------------------------------------------------------------------
...
[source,groovy]
------------------------------------------------------
include::../../test-resources/scoping.groovy[tags=newscope,indent=0]
include::../../test-resources/scoping.groovy[tags=scopeexit,indent=0]
------------------------------------------------------
...
[source,groovy]
------------------------------------------------------
include::../../test-resources/scoping_alt.groovy[tags=newscope,indent=0]
------------------------------------------------------
...
[source,groovy]
------------------------------------------------------
include::../../test-resources/scoping_alt.groovy[tags=currentscope,indent=0]
------------------------------------------------------
...
[source,groovy]
----
include::../../test/typing/PrecompiledExtension.groovy[tags=precompiled_groovy_extension,indent=0]
----
...
[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=setup_precompiled,indent=0]
----
...
[source,java]
----
include::../../test/typing/PrecompiledJavaExtension.java[tags=precompiled_java_extension,indent=0]
----
...
[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_setup_compilestatic,indent=0]
----
...
[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_script_direct,indent=0]
----
...
[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_setup_dynamic,indent=0]
----
...
[source,groovy]
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=example_robot_setup_compilestatic2,indent=0]
----
<1> apply `@CompileStatic` transparently
...
-------------------------------------
include::../../test-resources/robotextension2.groovy[tags=example_robot_extension,indent=0]
-------------------------------------
...
----
include::../../test/typing/TypeCheckingExtensionSpecTest.groovy[tags=robot_runtime_error_cs,indent=0]
----
...
-------------------------------------
include::../../test-resources/robotextension3.groovy[tags=example_robot_extension,indent=0]
-------------------------------------
